...
func TestStatusLineFull(t *testing.T) {
	got := StatusLine(statusInput("Sonnet", 30, 10), "ad here", 80)
...
func TestStatusLineTrimsModelParen(t *testing.T) {
	got := StatusLine(statusInput("Sonnet (claude-sonnet-4)", 0, 0), "", 80)
...
func TestStatusLineRounds(t *testing.T) {
	got := StatusLine(statusInput("M", 66.6, 12.4), "", 80)
...
func TestStatusLineNoAd(t *testing.T) {
	got := StatusLine(statusInput("M", 5, 5), "", 80)
...
func TestStatusLineShedsModelWhenNarrow(t *testing.T) {
	...
	got := StatusLine(statusInput("ClaudeModelLongName", 30, 10), ad, 45)
...
func TestStatusLineAdOnlyWhenTooNarrow(t *testing.T) {
	got := StatusLine(statusInput("M", 30, 10), "abcdefghijklmnop", 8)
